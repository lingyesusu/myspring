...
public class TokenManager {
	//用户登录管理
	public static final UserRealm realm = (UserRealm) SpringUtils.getBean("userRealm");
	//用户session管理
	public static final CustomSessionManager customSessionManager = (CustomSessionManager) SpringUtils.getBean("customSessionManager");
	/**
	 * 获取当前登录的用户User对象
	 * @return
	 */
