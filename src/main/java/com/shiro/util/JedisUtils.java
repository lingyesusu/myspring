...
public class JedisUtils {
		...
		try {
			...
			if (jedis.exists(getBytesKey(key))) {
				...
				for (Map.Entry<byte[], byte[]> e : map.entrySet()) {
					value.put(com.shiro.util.StringUtils.toString(e.getKey()), toObject(e.getValue()));
				}
	...
	public static byte[] getBytesKey(Object object) {
		if (object instanceof String) {
			return com.shiro.util.StringUtils.getBytes((String) object);
		} else {
	...
	public static Object getObjectKey(byte[] key) {
		try {
			return com.shiro.util.StringUtils.toString(key);
